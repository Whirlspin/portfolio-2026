  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-4xl px-6 lg:px-0 pt-28">
        ...
        <h3>Summary</h3>
        <p>
          Entrepreneurs are looking for cost effective ways to do business on
          the internet and eCommerce holds much potential. Simple, safe and easy
          - its not so complicated as one might think to launch an online store.
        </p>
        <p>
